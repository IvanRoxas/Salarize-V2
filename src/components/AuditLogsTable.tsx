...
export default function AuditLogsTable({ logs }: { logs: any[] }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex flex-col sm:flex-row sm:items-center gap-4">
        <h3 className="font-bold text-slate-800 flex-1">Security Logs Filter</h3>
