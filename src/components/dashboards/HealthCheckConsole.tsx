            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm mt-1.5">
                  <span className="font-semibold text-slate-700">Issues:</span> <span className="text-slate-500">None</span>
                </p>
              </div>
            </div>
            <button 
            ...
            {anomalousEmployees.map(emp => {
              return (
                <div key={emp.id} className="bg-white p-4 rounded-lg border border-red-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <span className="text-sm font-semibold text-slate-800 font-mono">{maskPII(emp.first_name, emp.last_name)}</span>
