    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <button 
          ...
          className="flex items-center justify-between p-5 bg-white border-2 border-violet-100 rounded-xl shadow-sm hover:border-violet-500 hover:bg-violet-50 hover:shadow-md transition-all duration-200 cursor-pointer group text-left"
        >
